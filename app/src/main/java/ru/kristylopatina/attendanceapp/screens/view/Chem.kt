...
import ru.kristylopatina.attendanceapp.ui.theme.Purple
...
fun ChemistryCard(
    ...
    Surface(
        modifier = Modifier
            ...
            .clickable
             {
                viewModel.initDatabase(Constants.Key.TYPE_ROOM, Constants.Key.TYPE_CHEM){
